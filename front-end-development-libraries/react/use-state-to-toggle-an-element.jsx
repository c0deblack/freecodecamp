...
You can't rely on the previous value of this.state or this.props when calculating the next value.
...
Using a function with setState guarantees you are working with the most current values.
...
Form without props if you need only the state:
